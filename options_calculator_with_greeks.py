...
#   S, K, r, sigma, q, T = pre_process_input(Stock, Exercise_Price, Interest_rate, Volatility, Yield_rate, T)
    ...
    a, M1, M2 = obtain_matrix_a(deltaT, sigma, r, q, M, algorithm)

    fc, fp = obtain_forward_matrices(N, M, deltaS, Smax, K, r, deltaT, a, M1, M2, algorithm)
...
# this part should be where we obtain data from the GUI inputs
S = 50
K = 50
r = 4
sigma = 40
...
S, K, r, sigma, q, T = pre_process_input(S, K, r, sigma, q, Expiration_date, Value_date)

#need to assign for 
calloption = option_price_calculator(S, K, r, sigma, q, T, algo, 'call')
putoption = option_price_calculator(S, K, r, sigma, q, T, algo, 'put')
...
#theta 1 day
theta_call_oneday = (option_price_calculator(S, K, r, sigma, q, T-1/365, algo, 'call')[0]-
              option_price_calculator(S, K, r, sigma, q, T, algo, 'call')[0])
theta_put_oneday = (option_price_calculator(S, K, r, sigma, q, T-1/365, algo, 'put')[0]-
                    option_price_calculator(S, K, r, sigma, q, T, algo, 'put')[0])


#theta 7 day
theta_call_sevenday = (option_price_calculator(S, K, r, sigma, q, T-7/365, algo, 'call')[0]-
              option_price_calculator(S, K, r, sigma, q, T, algo, 'call')[0])
theta_put_sevenday = (option_price_calculator(S, K, r, sigma, q, T-7/365, algo, 'put')[0]-
                    option_price_calculator(S, K, r, sigma, q, T, algo, 'put')[0])
